...
public class Magpie5
{
	...
	private String getRandomResponse ()
	{
		...
		randomResponses.add("Go on.");
		randomResponses.add("Oh really.");
		randomResponses.add("Are you sure about that?");
		randomResponses.add("Nani!");
	    Random r = new Random ();
		return randomResponses.get(r.nextInt(randomResponses.size()));
	}
